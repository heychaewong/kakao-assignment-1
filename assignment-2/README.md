...
과제 1에서 Vanilla JS로 만든 Todo 앱을 React + Tailwind CSS로 재구현하는 과제예요.  
컴포넌트 분리, 상태 관리, 스타일링 방식의 차이를 직접 경험해봐요.
...
- 본 과제는 AI 도구(ChatGPT, Claude 등)를 활용해 구현했어요
